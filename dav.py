# USAGE
# python dav.py --face face_detector --age age_detector
# Made by Rahul Dhar
...
def detect_and_predict_age(frame, faceNet, ageNet, minConf=0.5):
	...
	AGE_BUCKETS = ["(0-5)", "(5-10)", "(10-15)", "(15-20)", "(20-25)","(25-30)", "(30-35)", "(35-40),(40-45),(45-50),(50-60),(60-70),(70-80),(80-100)"]
	results = [] # initialize our results list
...
weightsPath = os.path.sep.join([args["face"],"face.caffemodel"])
...
while True:
	...
	for r in results:
		...
		cv2.rectangle(frame, (startX, startY), (endX, endY),(238,238,0), 2)
		cv2.putText(frame, text, (startX, y),
			cv2.FONT_HERSHEY_DUPLEX, 0.45, (255, 0, 0), 2)
